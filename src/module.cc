...
Napi::Object init(Napi::Env env, Napi::Object exports) {
    ...
    exports.Set(Napi::String::New(env, "krb5_cc_get_principal"), Napi::Function::New(env, _krb5_cc_get_principal));
    ...
    exports.Set(Napi::String::New(env, "krb5_get_credentials"), Napi::Function::New(env, _krb5_get_credentials));
    ...
    exports.Set(Napi::String::New(env, "krb5_parse_name"), Napi::Function::New(env, _krb5_parse_name));
    exports.Set(Napi::String::New(env, "krb5_parse_name_flags"), Napi::Function::New(env, _krb5_parse_name_flags));
